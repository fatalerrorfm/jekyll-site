...
# with open("./Fatal+Error+-+Episode+1.mp3" , "rb") as f:
#   response = requests.post(base_url + "/upload",
#                           headers=headers,
#                           data=f)

filenames = [
    "314582175-fatalerrorfm-episode-23-objective-c-vs-swift.mp3",
...
for filename in filenames:
    ...
    upload_url = f"https://fatalerror.fm/attachments/{filename}" 
